...
function BSNLApp() {
  return (
    <div className="w-full h-fit py-2 bg-[#111] flex justify-around">
      <div className="text-white w-[25%] h-fit py-10">
        <h2 className="text-2xl font-bold tracking-wide pt-10">Experience All New BSNL App</h2>
        <h3 className="text-lg py-2">Download the App for exclusive offers,manage your account and much more, on-the-go.
        </h3>
