...
function PayBills() {
  ...
  return (
    <div className="w-full pb-10 bg-[#111] text-white text-center">
      ...
      <button className="px-2 mx-2 py-1 mt-2 text-[#FFFFFF] border-b-[3px]">
        <CiMobile2 className="inline-block" size={"1.5em"} />
        Mobile
      </button>
      <button className="px-2 mx-2 py-1 mt-2 text-[#FFFFFF9A]">
      ...
      <div className="bg-[#2b38ca] lg:w-5/12 md:w-1/2 sm:w-3/5 w-4/5 m-auto rounded-xl mt-4 py-5 lg:px-20 md:px-10 px-5">
        <div className="bg-[#5e4fff84] w-fit rounded-full">
          <button className="px-4 py-1 bg-[#111] rounded-full">
      ...
      <div className="m-auto flex gap-5 mt-5 w-fit flex-wrap justify-evenly">
        {newConnection.map((elem, index) => {
          return (
            <div className="bg-black w-32 h-32 border-2 border-white hover:border-red-700 rounded-lg" key={index}>
